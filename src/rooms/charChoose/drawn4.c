...
void drawn4(int x, ALLEGRO_FONT *font, ALLEGRO_BITMAP* img1, ALLEGRO_BITMAP* img2, ALLEGRO_BITMAP* img3, ALLEGRO_BITMAP* img4, int pfpChoosed){
    ...
    al_draw_scaled_bitmap(img3,0, 0, al_get_bitmap_width(img1), al_get_bitmap_height(img1), larguraEscolhida/2 - (100*scale) - (200*scale), alturaEscolhida/2 + (100*scale), 200*scale, 200*scale, 0);
    al_draw_scaled_bitmap(img4,0, 0, al_get_bitmap_width(img1), al_get_bitmap_height(img1), larguraEscolhida/2 + (100*scale), alturaEscolhida/2 + (100*scale), 200*scale, 200*scale, 0);
